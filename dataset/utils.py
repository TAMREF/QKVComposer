...
class MidiParser:
    def __init__(self, cfg: DictConfig):
        ...
        self.cfg = cfg
        self.data_len = cfg.data.data_len + 1
    ...
    def parse_midi(self, path: str):
        ...
        if len(token_list) < self.data_len:
            ...
            time_list += [0] * (self.data_len - len(token_list))
        ...
        return (token_list[:-1], time_list[:-1]), (token_list[1:], time_list[1:])

    def recon_midi(self, token_list, time_list, path):
        velocity = 20
        start_times = [0] * 128
